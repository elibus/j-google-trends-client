 ...
 */
public class GoogleTrendsClientRunException extends Exception {

  /**
   * Creates a new instance of <code>HierarchicalDownloaderException</code>
   * without detail message.
   */
  public GoogleTrendsClientRunException() {
  }
   ...
   */
  public GoogleTrendsClientRunException(String msg) {
    super(msg);
  }
   ...
   */
  public GoogleTrendsClientRunException(Exception e) {
    super(e);
  }
}
